...
<div class="mail-box-header">
    <div class="pull-right tooltip-demo">
        ...
        <a class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" onclick="bandejamensaje()" title="Discard email"><i class="fa fa-times"></i> Cancelar</a>
    </div>
    <h2>
        Nuevo Correo
    </h2>
...
<div class="mail-box">
    ...
    <div class="mail-body text-right tooltip-demo">
        ...
        <a class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" onclick="bandejamensaje()" title="Discard email"><i class="fa fa-times"></i> Cancelar</a>
        <!--<a href="mailbox.html" class="btn btn-white btn-sm" data-toggle="tooltip" data-placement="top" title="Move to draft folder"><i class="fa fa-pencil"></i> Borrador</a>-->
    </div>
    <div class="clearfix"></div>
