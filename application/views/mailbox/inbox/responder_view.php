    ...
    <div class="mail-body">
        ...
        <form class="form-horizontal" method="get">
            <div class="form-group"><label class="col-sm-2 control-label">Para:</label>
                ...
                <div class="col-sm-10"><input type="text" id="txtemailreceptor" name="txtemailreceptor" disabled="true" class="form-control" value="<?php echo $txtcorreo ?>"></div>
            </div>            <div class="form-group"><label class="col-sm-2 control-label">Asunto:</label>
