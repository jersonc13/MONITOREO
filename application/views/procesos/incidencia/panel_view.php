<script src="<?php echo URL_SCRIPTS ?>/procesos/jsIncidencia.js" type="text/javascript"></script>
        ...
        <div class="col-md-12">
            <div class="tabbable tabbable-custom boxless tabbable-reversed">
                ...
                <div class="tab-content">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-content">
                                                <div id="mostrar_qry" >
                                                    <?php $this->load->view('procesos/incidencia/qry_view') ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <!-- <div class="tab-pane" id="tab_1">Nuevo</div> -->
