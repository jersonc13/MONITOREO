<script src="<?php echo URL_SCRIPTS ?>/requerimiento/jsBandeja.js" type="text/javascript"></script>
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li class="active">
                        <a href="#tab_0" data-toggle="tab">
                            Espera de Atención </a>
                    </li>
                    <li>
                        <a href="#tab_1" data-toggle="tab" id="listar_anc_mis_incidencias">
                            Mis Requerimientos Asignados </a>
                    </li>
                    <!-- <li >
	                                ...
	                                <div class="row">
                                        ...
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-content">
                                                <div id="mostrar_qry" >
                                                	<?php $this->load->view('procesos/requerimiento/qry_bandeja_view'); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
