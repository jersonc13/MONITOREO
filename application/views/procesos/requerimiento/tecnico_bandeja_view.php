<script src="<?php echo URL_SCRIPTS ?>/requerimiento/jsBandejaTecnico.js" type="text/javascript"></script>
	                                ...
	                                <div class="row">
                                        ...
                                        <div class="ibox float-e-margins">
                                            <div class="ibox-content">
                                                <div id="mostrar_qry" >
                                                	<?php $this->load->view('procesos/requerimiento/qry_tecnico_bandeja_view'); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
