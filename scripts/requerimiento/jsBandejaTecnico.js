...
function tomarCaso(id){
    get_page('bandejatecnico/cambiarEstado', 'mostrar_qry',{
        id:id
    });    
    
}

function getsolucionar(id){
    get_page('bandejatecnico/getsolucionar', 'qry_casos_asignados',{id:id}); 
}